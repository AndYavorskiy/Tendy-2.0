...
namespace Tendy.Common.Exceptions
{
    public static class ExceptionsMessages
    {
		...
		public static readonly ErrorInfo CantUpdateLinks = new ErrorInfo("03x00002", "Can not update Links!");
		//--Files
		public static readonly ErrorInfo CantFindFiles = new ErrorInfo("04x00001", "Can not find Files!");
		public static readonly ErrorInfo CantUpdateFiles = new ErrorInfo("04x00002", "Can not update Files!");

		//Account Configuration
		public static readonly ErrorInfo CantUpdateAccountConfiguration = new ErrorInfo("05x00001", "Can not update Account Configuration!");

		//Requsts
		public static readonly ErrorInfo CannotAcceptDeclaimRequest = new ErrorInfo("06x00001", "Can not Accept/Declaim Request!");

		//Notifications
		public static readonly ErrorInfo CannotDismissNotification = new ErrorInfo("07x00001", "Can not Dismiss Notification!");
	}
}