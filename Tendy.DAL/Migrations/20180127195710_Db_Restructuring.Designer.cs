...
namespace Tendy.DAL.Migrations
{
    ...
    [Migration("20180127195710_Db_Restructuring")]
    partial class Db_Restructuring
    {
            ...
            modelBuilder.Entity("Tendy.DAL.Entities.Attachment", b =>
                {
                    b.HasOne("Tendy.DAL.Entities.Idea", "Idea")
                        .WithOne("Attachment")
                        .HasForeignKey("Tendy.DAL.Entities.Attachment", "IdeaId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("Tendy.DAL.Entities.File", b =>
                {
                    b.HasOne("Tendy.DAL.Entities.Attachment", "Attachment")
                        .WithMany("Files")
